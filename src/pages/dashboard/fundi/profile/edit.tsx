...
export default function FundiProfileEdit() {
        ...
        if (profileResponse.success && profileResponse.data) {
          ...
          if (data.fundiProfile) {
            setFundiProfile({
              ...
              services: data.fundiProfile.services?.map((s: any) => s._id || s) || [],
  ...
  // Language management
  const addLanguage = () => {
    if (newLanguage.trim() && !userProfile.languages.includes(newLanguage.trim())) {
      setUserProfile(prev => ({
        ...prev,
...
const removeService = (serviceId: string) => {
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-semibold text-[#0A2647] flex items-center gap-2">
                <User size={24} />
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Date of Birth: {userProfile.dateOfBirth ? new Date(userProfile.dateOfBirth).toLocaleDateString() : 'Not set'}
                  </label>
                ...
                {userProfile.languages.length > 0 && (
                  <div className="flex flex-wrap gap-2">
                    {userProfile.languages.map((lang, index) => (
                      ...
                      >
                        {lang}
                        <button onClick={() => removeLanguage(index)} className="hover:text-blue-900">
                          ×
                        </button>
                      </span>
                    ))}
              ...
              <div className="flex justify-end pt-4 border-t">
                <button
                  ...
                  className="bg-[#0A2647] text-white px-8 py-3 rounded-lg hover:bg-[#0d3157] transition-colors font-semibold flex items-center gap-2 disabled:opacity-50"
                >
                  {savingProfile ? (
                    <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={(e) => setFundiProfile(prev => ({ ...prev, bio: e.target.value }))}
                    rows={4}
                    maxLength={1000}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A2647] text-gray-900"
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <input
                      ...
                      onChange={(e) => setFundiProfile(prev => ({ ...prev, experience: parseInt(e.target.value) || 0 }))}
                      min="0"
                      max="50"
                      className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A2647] text-gray-900"
                    />
  ...
  <div className="bg-gray-50 p-4 rounded-lg mb-4">
    <h4 className="font-medium text-gray-700 mb-3">Add Service</h4>
    <div className="flex gap-2">
      ...
      >
        ...
        {availableServices
          .filter(service => !fundiProfile.services.includes(service._id))
          .map(service => (
  ...
  {fundiProfile.services.length > 0 ? (
    <div className="space-y-3">
      <h4 className="font-medium text-gray-700">Your Services ({fundiProfile.services.length})</h4>
            ...
            >
              <div className="flex items-center gap-3">
                <div className="bg-orange-100 p-2 rounded-lg">
                  <Briefcase size={20} className="text-[#FF6B35]" />
                </div>
                <div>
    ...
    <div className="text-center py-8 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
      ...
      <p className="text-gray-400 text-sm">Use the dropdown above to add your first service</p>
    </div>
  )}
</div>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-4">
                  <h4 className="font-medium text-gray-700 mb-3">Add Pricing</h4>
                  <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
                    ...
                    <input
                      ...
                      onChange={(e) => setNewPricing(prev => ({
                        ...prev,
                        maxRate: e.target.value === '' ? undefined : parseInt(e.target.value, 10)
                      }))}
                ...
                {fundiProfile.pricing.length > 0 && (
                  <div className="space-y-2">
                    {fundiProfile.pricing.map((price, index) => {
                      const service = availableServices.find(s => s._id === price.serviceId);
                      return (
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-4">
                  <h4 className="font-medium text-gray-700 mb-3">Add Certification</h4>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-4">
                  <h4 className="font-medium text-gray-700 mb-3">Add Portfolio Item</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFundiProfile(prev => ({
                        ...prev,
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFundiProfile(prev => ({
                        ...prev,
                        bankDetails: { ...prev.bankDetails, mpesaNumber: e.target.value }
                      }))}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0A2647] text-gray-900"
                    />
                  </div>
              ...
              <div className="flex justify-end pt-6 border-t">
                <button
                  ...
                  className="bg-[#FF6B35] text-white px-8 py-3 rounded-lg hover:bg-[#ff5722] transition-colors font-semibold flex items-center gap-2 disabled:opacity-50"
                >
                  {savingFundiProfile ? (
                    <>
                      <Loader className="animate-spin h-5 w-5" />
