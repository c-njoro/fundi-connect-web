...
export default function AdminServices() {
    ...
    const handleSaveService = async (isEdit: boolean) => {
        ...
        try {
            if(isEdit && selectedService){
                const response = await serviceService.updateService(selectedService._id.toString(), serviceForm);
    ...
    const updateSubServicePrice = (index: number, field: 'min' | 'max', value: number) => {
        setServiceForm(prev => ({
            ...prev,
            subServices: prev.subServices.map((sub, i) => 
                i === index ? { 
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-6">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h1 className="text-2xl font-bold text-[#0A2647]">Services Management</h1>
                ...
                <div className="grid gap-6">
                    {filteredServices.length === 0 ? (
                        ...
                        filteredServices.map((service) => (
                            <div key={service._id.toString()} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                                {/* Service Header */}
                                <div className="p-6 border-b border-gray-200">
                                    <div className="flex items-start justify-between">
                                        ...
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <button
                                                onClick={() => handleDeleteService(service._id.toString())}
                                            ...
                                            <button
                                                onClick={() => setExpandedService(
                                                    expandedService === service._id.toString() ? null : service._id.toString()
                                                )}
                                ...
                                {expandedService === service._id.toString() && (
                                    <div className="p-6 bg-gray-50">
                                        <h4 className="text-lg font-semibold text-[#0A2647] mb-4">Sub-services</h4>
                                                ...
                                                <div key={index} className="bg-white p-4 rounded-lg border border-gray-200">
                                                    <div className="flex items-start justify-between">
                                                        <div className="flex-1">
                                                            ...
                                                            <p className="text-gray-600 text-sm mt-1">{subService.description}</p>
                                                            <div className="flex items-center space-x-4 mt-2">
                                                                <div className="flex items-center space-x-1 text-sm text-gray-500">
                                                                    <Clock size={14} />
                                                                    <span>{formatDuration(subService.estimatedDuration)}</span>
                                                                </div>
                                                                <div className="flex items-center space-x-1 text-sm text-gray-500">
                                                                    <DollarSign size={14} />
                                                                    <span>
                                                                        KSh {subService.suggestedPrice.min.toLocaleString()} - {subService.suggestedPrice.max.toLocaleString()}
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="p-6">
                    <div className="space-y-6">
                        {/* Basic Information */}
                        <div>
                            <h3 className="text-lg font-semibold text-[#0A2647] mb-4">Basic Information</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-4">
                                <h3 className="text-lg font-semibold text-[#0A2647]">Sub-services</h3>
                                <button
                                    type="button"
                            ...
                            <div className="space-y-4">
                                {serviceForm.subServices.map((subService: any, index: number) => (
                                    <div key={index} className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                        <div className="flex items-center justify-between mb-3">
                                            <h4 className="font-medium text-gray-900">Sub-service {index + 1}</h4>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => updateSubService(index, 'estimatedDuration', parseInt(e.target.value))}
                                                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A2647] focus:border-transparent text-gray-800"
                                                    min="1"
                                                />
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => updateSubServicePrice(index, 'min', parseInt(e.target.value))}
                                                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A2647] focus:border-transparent text-gray-800"
                                                    min="0"
                                                />
                                            </div>
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => updateSubServicePrice(index, 'max', parseInt(e.target.value))}
                                                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0A2647] focus:border-transparent text-gray-800"
                                                    min="0"
                                                />
                                            </div>
