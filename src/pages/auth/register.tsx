...
const setNested = <T extends Record<string, any>>(
  obj: T,
  keys: string[],
  value: any
): T => {
...
const RegisterPage = () => {
  ...
  function validateUserInput({
    ...
    if (!phone || !phoneRegex.test(phone)) {
      errors.phone =
        "Invalid Kenyan phone number. Example: 0712345678 or +254712345678";
    }
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#0A2647] to-[#003366] text-white p-8 flex-col justify-center items-center fixed left-0 top-0 h-full">
        <div className="max-w-md text-center">
          ...
          <div className="text-left space-y-4">
            <h3 className="text-xl   mb-4">Why Join Fundi Connect?</h3>
          ...
          <div className="mx-auto w-full max-w-md">
            ...
            >
              ...
              <div className="mb-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label
                        htmlFor="location.coordinates.coordinates.0"
                        className="block text-sm font-medium text-gray-700 mb-1"
                      >
                        Longitude
                      </label>
                    ...
                    <div>
                      <label
                        htmlFor="location.coordinates.coordinates.1"
                        className="block text-sm font-medium text-gray-700 mb-1"
                      >
                        Latitude
                      </label>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-orange-500 text-white py-3 px-4 rounded-md hover:bg-orange-600 focus:outline-none focus:ring-orange-500 focus:ring-offset-2 transition duration-200   disabled:opacity-60"
              >
                {loading ? "Creating account..." : "Create Account"}
              </button>
              {submissionError && (
                <p className="text-red-600 text-sm w-full text-center py-2 bg-red-100 border-red-400 border mt-2 rounded-lg">
                  {submissionError}
                </p>
              )}
